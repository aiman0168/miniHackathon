...
export default function CarDetails1(){
    return(
        <div className='flex items-center flex-col ml-32 mr-32'>
            <h1 className='underline text-black-500 text-4xl font-bold'>Honda Civic 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            <Image src="/car4.jpg" alt="Honda Civic" width={400} height={400}></Image>
            ...
            <p className='text-2xl text-green-500 mt-12'>PKR 8,600,000</p>
