...
export default function CarDetails1(){
    ...
    return(
        <div className='flex items-center flex-col ml-32 mr-32'>
            <h1 className='underline text-black-500 text-4xl font-bold'>Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            <Image src="/car1.jpg" alt="Suzuki Alto" width={400} height={400}></Image>
            ...
            <p className='text-2xl text-green-500 mt-12'>PKR 3,00,000</p>
