...
export default function CarDetails2(){
    ...
    return(
        <div className='flex items-center flex-col ml-32 mr-32'>
            <h1 className='underline text-black-500 text-4xl font-bold'>Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            <Image src="/car2.jpg" alt="Toyota Corolla" width={400} height={400}></Image>
            ...
            <p className='text-2xl text-green-500 mt-12'>PKR 7,500,000</p>
